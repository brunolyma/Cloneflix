  ...
  return (
    ...
    >
      <>
        ...
        <div className=" relative pt-[56.25%]">
          ...
          <div className=" absolute bottom-10 flex w-full items-center justify-between px-10">
            <div className=" flex space-x-2">
              <button className=" flex items-center gap-x-2 rounded text-base bg-white px-8 md:text-xl font-bold text-dark transition hover:bg-button-player">
                <FaPlay className=" modalIcon text-dark" />
                Play
              </button>

              <button className="modalButton" onClick={handleList}>
                {addedToList ? (
                  <CheckIcon className="modalIcon" />
                ) : (
        ...
        <div className=" flex space-x-16 px-10 py-8 rounded-b-md bg-modal-closebutton">
